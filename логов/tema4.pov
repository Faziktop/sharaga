...
#declare shkaf = union { 
   ...
   object { wood_door translate <0.5, -12.6, 0> }
   object { wood_door translate <0.5+6+0.15, -12.6, 0> }
   object { wood_door translate <0.5+6+0.15+6.1+0.15, -12.6, 0> }
   object { finished_bottle translate <1.3, 0, 11> }
   object { finished_bottle translate <1.3+2.1, 0, 11> }
   object { finished_bottle translate <1.3+4.25, 0, 11> }
}
...
object { glass_door translate <2.5, 11.3, 10.2-0.25> }
...
object { sugar_print translate <2.6, 16.5, 9.999-0.25> }
object { for_customers_print translate <12, 12.9, 1.999> }
